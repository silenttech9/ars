...
<div class="portlet light bordered">
    <div class="alert alert-danger">
            NOTE: Please complete the form that marked (*)
    </div>
...
<div class="row">
    <div class="portlet-body form">
        <div class="form-body">
            <div class='col-md-12'>
                <div class="form-group form-md-line-input">
                    <?= Html::activeTextArea($model,'user_address',['class'=>'form-control','id'=>'form_control_1','rows'=>'2']); ?>
...
<div class="row">
    <div class="portlet-body form">
        <div class="form-body">
            ...
            <div class='col-md-4'>
                <div class="form-group form-md-line-input">
                    <?= Html::activePasswordInput($model,'password_hash',['class'=>'form-control','id'=>'form_control_1']); ?>
